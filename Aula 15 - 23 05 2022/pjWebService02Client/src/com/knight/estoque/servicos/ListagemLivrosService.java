 ...
 * 
 */
@WebServiceClient(name = "ListagemLivrosService", targetNamespace = "http://servicos.estoque.knight.com/", wsdlLocation = "http://localhost:8175/livros?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8175/livros?wsdl");
